...
const MealForm = () => {
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      if (!name  ) {
        setError('Missing some name');
      }
      console.log({
        body: { name, description, ingredients, steps, category,  },
              ...
              <BasicFormWrapper>
                <Form form={form} name="meal_form" onFinish={onFinish}>
                  ...
                  <Form.Item
                    name="calories"
                    label="Calories"
                    rules={[{ required: false, message: 'Please input the calories!' }]}
                  >
                  ...
                  <Form.Item
                    name="category"
                    label="Category"
                    rules={[{ required: false, message: 'Please input the Food Category!' }]}
                  >
